...
const ItemDetailContainer = () => {
  ...
  return (
  <> 
    <div className="SubtituloProductoCompleto">
      <h2 className='SubTitulos'>Productos</h2>
    </div>
    <div className="ProductList-Container">
      {Products.map( p => <ItemDetail product={p}/>
      )}
    </div>
    <div className="FooterProductosCompletos">
    <h4 className="Footer">Copyright © 2022 - All right reserved by ACME Industries Ltd</h4>
